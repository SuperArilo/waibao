    ...
    <div class="hard-hat-check">
        <div class="title-function">
            <div class="left-input-box">
                ...
                <div class="item-button" @click="getareaViolation">
...
import { areaViolation , areaViolationOut } from '@/util/api.js'
...
export default {
    ...
    methods:{
        getareaViolation(){
            ...
            areaViolation({starTime: this.beforeDate, overTime: this.afterDate, cameraId: this.cameraId, pageNumber: this.pageNumber, pageSize: this.pageSize}).then(resq => {
                if(resq.code === 200){
        ...
        fileGet(){
            ...
            areaViolationOut({starTime: this.beforeDate, overTime: this.afterDate, cameraId: this.cameraId}).then(resq => {
                if(resq.code === 200){
