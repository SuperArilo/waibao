    ...
    <div class="hard-hat-check"> 
        <div class="title-function">
            <div class="left-input-box">
                ...
                <div class="item-button" @click="getshelvesViolation">
...
import { shelvesViolation , shelvesViolationOut } from '@/util/api.js'
...
export default {
    ...
    methods:{
        getshelvesViolation(){
            ...
            shelvesViolation({starTime: this.beforeDate, overTime: this.afterDate, cameraId: this.cameraId, pageNumber: this.pageNumber, pageSize: this.pageSize}).then(resq => {
                if(resq.code === 200){
        ...
        fileGet(){
            ...
            shelvesViolationOut({starTime: this.beforeDate, overTime: this.afterDate, cameraId: this.cameraId}).then(resq => {
                if(resq.code === 200){
